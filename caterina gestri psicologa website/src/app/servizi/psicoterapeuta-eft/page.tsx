      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-12">
            ...
            {/* Per chi è indicata */}
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Per quali problemi è indicata?</h2>
              <div className="space-y-3">
                {[
                  'Conflitti frequenti e cicli negativi di discussione',
                  'Mancanza di comunicazione e intimità',
                  'Tradimento e ricostruzione della fiducia',
                  'Disconnessione emotiva nella relazione',
                  'Difficoltà sessuale o affettiva',
                  'Conflitti relativi a figli e famiglia',
                  'Crisi di coppia e dubbi sulla relazione',
                  'Preparazione al matrimonio o ad impegni importanti',
                  'Rinnegazione della intimità emotiva',
                ].map((item, index) => (
            ...
            {/* Come funziona */}
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Le fasi del percorso EFT</h2>
              <div className="space-y-4">
                {[
                  {
                    phase: 'Fase 1: Valutazione e de-escalation',
                    desc: 'Analisi dei cicli negativi attuali e creazione di sicurezza emotiva per entrambi i partner.',
                  },
                  {
                    phase: 'Fase 2: Identificazione dei sentimenti',
                    desc: 'Scoperta dei sentimenti sottostanti (paura, dolore, vulnerabilità) dietro i comportamenti.',
                  },
                  {
                    phase: 'Fase 3: Cambiamento interattivo',
                    desc: 'Modifica dei cicli negativi e insegnamento di nuovi modi di comunicare e connettersi.',
                  },
                  {
                    phase: 'Fase 4: Consolidamento e prevenzione',
                    desc: 'Sviluppo di strategie per mantenere l\'intimità emotiva e prevenire ricadute nei vecchi cicli.',
                  },
                ].map((item, index) => (
          ...
          <aside className="space-y-6">
            ...
            <Card variant="elevated" className="p-6">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-900 font-semibold">50-80 minuti</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-semibold">12-20 sedute</p>
                </div>
                <div>
            ...
            <Card variant="elevated" className="p-6 bg-gradient-to-b from-orange-50 to-white border border-orange-200">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Rinforza la tua relazione</h3>
              <p className="text-gray-700 text-sm mb-6">
                Contattami per una consulenza di coppia e scopri come l'EFT può trasformare la vostra relazione.
              </p>
              <div className="space-y-3">
                <Link href="/contatti">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                q: 'Quanto tempo prima di vedere miglioramenti?',
                a: 'Molte coppie notano miglioramenti nella comunicazione già dopo 2-3 sedute. Una trasformazione più profonda richiede solitamente 12-20 sedute.',
              },
              {
