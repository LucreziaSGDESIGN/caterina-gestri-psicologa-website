          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
            ...
            <div className="md:col-span-1">
              <div className="sticky top-8">
                <div className="bg-gradient-to-br from-primary-100 to-accent-100 rounded-lg p-8 mb-8 h-80" />
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-neutral-900 mb-4">Aree di Specializzazione</h2>
              ...
              <div>
                ...
                <p className="text-neutral-600 mb-4">
                  Offro sedute <strong>in presenza</strong> presso studi professionali e <strong>online via videochiamata</strong> con la massima riservatezza e professionalità.
                </p>
                <ul className="space-y-2 text-neutral-600">
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">📍</span>
                    <span><strong>Arezzo</strong> - Centro Città</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">📍</span>
                    <span><strong>Lucca</strong> - Su appuntamento</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">📍</span>
                    <span><strong>Pisa</strong> - Su appuntamento</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">📍</span>
                    <span><strong>Firenze</strong> - Su appuntamento</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600">💻</span>
