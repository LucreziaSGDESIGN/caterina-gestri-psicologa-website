...
export default function ChiSono() {
  return (
    <>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-accent-50 to-primary-50 border-t border-accent-200">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-neutral-900 mb-3">Come Contattarmi</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {/* Phone */}
            <div className="bg-white p-6 rounded-lg border border-accent-300 shadow-sm">
              <p className="text-xs font-semibold text-neutral-600 uppercase tracking-wide mb-3">Telefono</p>
              <p className="text-2xl font-bold text-neutral-900 mb-2 whitespace-nowrap">+39 338 111 0142</p>
              <p className="text-sm text-neutral-600">Contattami via telefono per fissare una consulenza</p>
            </div>

            {/* Email */}
            <div className="bg-white p-6 rounded-lg border border-accent-300 shadow-sm">
              <p className="text-xs font-semibold text-neutral-600 uppercase tracking-wide mb-3">Email</p>
              <p className="text-lg font-bold text-neutral-900 mb-2 break-all">gestricaterina@gmail.com</p>
              <p className="text-sm text-neutral-600">Per informazioni generali puoi scrivere una email</p>
            </div>
          </div>
        </div>
      </section>
