...
export const metadata: Metadata = {
  title: 'Contatti Caterina Gestri | Psicologa Prato (Toscana)',
  description: 'Contatta Caterina Gestri, psicologa specializzata in EMDR e trauma. Tel: +39 338 111 0142 | Email: gestricaterina@gmail.com | Consulenze a Prato (Toscana) e online',
  keywords: 'contatti psicologa, contatti psicoterapeuta Prato, consulenza psicologica Toscana, EMDR Prato',
}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-600">
                Per informazioni generali puoi scrivere una email
              </p>
            </div>
          </div>
            ...
            <div className="bg-neutral-50 rounded-lg p-8 border border-neutral-200">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-neutral-900">Prato (Toscana)</p>
