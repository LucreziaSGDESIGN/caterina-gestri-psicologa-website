...
export const metadata: Metadata = {
  title: 'Caterina Gestri - Psicologa Psicoterapeuta Prato',
  description: 'Psicologa-Psicoterapeuta specializzata in psicoterapia cognitivo-comportamentale, EMDR, EFT e Schema Therapy. Consulenze a Prato e online.',
  keywords: 'psicologa, psicoterapeuta, Prato, CBT, EMDR, EFT, ansia, depressione, trauma, online',
  ...
  openGraph: {
    ...
    description: 'Psicoterapia cognitivo-comportamentale, EMDR, EFT, Schema Therapy. Disponibile a Prato e online.',
  },
}
